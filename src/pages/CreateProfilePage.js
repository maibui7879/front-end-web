...
import { Form, Input, DatePicker, Radio, Button, Upload, message, Typography, Skeleton, Card, Row, Col } from 'antd';
            ...
            >
                ...
                <Row gutter={[32, 32]} className="items-center">
                    <Col xs={24} md={6} className="text-center">
                        ...
                        <Title level={5}>{form.getFieldValue('full_name') || 'Tên người dùng'}</Title>
                        <Text type="secondary">{form.getFieldValue('email') || 'Email'}</Text>
                    </Col>
