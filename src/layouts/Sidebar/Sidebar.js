            ...
            <ul className="mt-4 space-y-1 px-3">
                ...
                <li>
                    ...
                    >
                        ...
                        <button onClick={toggleTeams} className="ml-auto text-gray-600 hover:text-blue-700">
                            <i className={`fa text-xs ${showTeams ? 'fa-chevron-up' : 'fa-chevron-down'}`} />
                        </button>
                    </div>
                </li>
                ...
                {showTeams && (
                    <>
                        {teamLoading && <li className="text-gray-500 ml-4 text-xs">Đang tải nhóm...</li>}
                        {!teamLoading && teamError && <li className="text-red-500 ml-4 text-xs">Không có nhóm</li>}
